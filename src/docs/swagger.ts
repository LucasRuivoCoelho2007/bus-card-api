    ...
    schemas: {
      ...
      User: {
        ...
        properties: {
          _id: {
            type: "string",
            example: "66e123456789abcdef123456",
          },
          name: {
            type: "string",
            example: "Lucas",
      ...
      Card: {
        ...
        properties: {
            ...
            description: "IDs das últimas transações do cartão.",
            },
        },
        },
        ...
        properties: {
            ...
            enum: ["student", "standard"],
            example: "standard",
            description: "Novo tipo do cartão.",
            },
        },
        },
      ...
      Transaction: {
        ...
        properties: {
            ...
            type: "string",
            example: "665f1a2b3c4d5e6f78905678",
            description: "ID do cartão relacionado à transação.",
            },
            amount: {
            type: "number",
            example: 50,
            description:
                "Valor da transação. Depósitos possuem valor positivo e cobranças possuem valor negativo.",
            },
            date: {
            type: "string",
            format: "date-time",
  ...
  paths: {
    "/auth/login": {
        post: {
            ...
            description:
            "Autentica o usuário utilizando e-mail e senha e retorna um token JWT.",
            tags: ["Auth"],
    ...
    "/cards": {
        post: {
            ...
            "400": {
                description: "Tipo de cartão inválido.",
            },
            "401": {
        ...
        get: {
            ...
            description:
            "Retorna todos os cartões pertencentes ao usuário autenticado.",
            tags: ["Cards"],
            security: [{ bearerAuth: [] }],
        ...
        get: {
            ...
            description:
            "Retorna os dados de um cartão pertencente ao usuário autenticado.",
            tags: ["Cards"],
            security: [{ bearerAuth: [] }],
        ...
        put: {
            ...
            description:
            "Atualiza o tipo de um cartão pertencente ao usuário autenticado.",
            tags: ["Cards"],
            security: [{ bearerAuth: [] }],
            ...
            "400": {
                description: "ID ou tipo de cartão inválido.",
            },
            "401": {
                description: "Usuário não autenticado.",
            },
        ...
        delete: {
            ...
            description:
            "Exclui um cartão pertencente ao usuário autenticado.",
            tags: ["Cards"],
            security: [{ bearerAuth: [] }],
    ...
    "/cards/{id}/deposit": {
        post: {
            summary: "Recarrega o saldo do cartão",
            description:
            "Adiciona um valor positivo ao saldo do cartão e registra uma transação.",
            tags: ["Cards"],
            security: [{ bearerAuth: [] }],
    ...
    "/cards/{id}/charge": {
        post: {
            summary: "Realiza uma cobrança no cartão",
            description:
            "Realiza uma cobrança de R$ 5,00 no cartão e registra uma transação.",
            tags: ["Cards"],
            security: [{ bearerAuth: [] }],
    ...
    "/transactions": {
        get: {
            ...
            description:
            "Retorna todas as transações pertencentes aos cartões do usuário autenticado.",
            tags: ["Transactions"],
            security: [{ bearerAuth: [] }],
        ...
        get: {
            summary: "Lista as transações de um cartão",
            description:
            "Retorna as transações de um cartão pertencente ao usuário autenticado.",
            tags: ["Transactions"],
            security: [{ bearerAuth: [] }],
            ...
            responses: {
            "200": {
                description: "Lista de transações do cartão.",
                content: {
                "application/json": {
                    schema: {
                    type: "array",
            ...
            "404": {
                description: "Nenhuma transação encontrada para este cartão.",
            },
            },
        },
    },
